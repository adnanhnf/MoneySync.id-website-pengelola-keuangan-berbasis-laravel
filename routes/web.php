...
Route::prefix('account')->group(function () {
    ...
    Route::get('/laporan_credit/pdf', 'account\LaporanCreditController@view_pdf')->name('account.laporan_credit.pdf');
    ...
    Route::get('/laporan_debit/pdf', 'account\LaporanDebitController@view_pdf')->name('account.laporan_debit.pdf');
